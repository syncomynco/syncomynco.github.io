...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<div style=\"text-align:center\">\n<h2> {{cnt | async }} {{ msg | async}} </h2>\n<button (click)=\"onClick()\">Clicked {{ cnt | async }} times</button>\n</div>\n\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_actions__ = __webpack_require__("../../../../../src/app/store/actions.ts");
...
//curl -u syncomynco https://api.github.com/users/syncomynco/repos
var AppComponent = (function () {
    ...
    AppComponent.prototype.onClick = function () {
        this.ngRedux.dispatch({ type: __WEBPACK_IMPORTED_MODULE_2__store_actions__["a" /* EAction */].INC, extras: 'ASDASDASD' });
    };
    AppComponent.prototype.onClick2 = function () {
        this.ngRedux.dispatch({ type: 'asdasd', extras: 'ASDASDASD' });
    };
    return AppComponent;
}());
__decorate([
...
], AppComponent.prototype, "cnt", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_redux_store__["select"])(),
...
], AppComponent.prototype, "msg", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store_state__ = __webpack_require__("../../../../../src/app/store/state.ts");
...
var AppModule = (function () {
    function AppModule(ngRedux) {
        ngRedux.configureStore(__WEBPACK_IMPORTED_MODULE_4__store_reducers__["a" /* rootReducer */], __WEBPACK_IMPORTED_MODULE_5__store_state__["a" /* InitialState */] /*, [ createLogger() ]*/);
    }
    return AppModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EAction; });
var EAction;
(function (EAction) {
    EAction[EAction["INC"] = 0] = "INC";
    EAction[EAction["DEC"] = 1] = "DEC";
})(EAction || (EAction = {}));
...
function rootReducer(state, action) {
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["a" /* EAction */].INC:
            return { cnt: state.cnt + 1, msg: '' };
        case __WEBPACK_IMPORTED_MODULE_0__actions__["a" /* EAction */].DEC:
            return { cnt: state.cnt - 1, msg: '' };
    }
    if (action.type !== __WEBPACK_IMPORTED_MODULE_0__actions__["a" /* EAction */]) {
        return { cnt: null, msg: 'Not my state!' };
    }
    return state;
}
...
;
function initState() {
    return { cnt: 0, msg: 'welcome message' };
}
